...
import com.example.adhit.bikubiku.ui.ruangBelajarChatting.ClosedMessageViewHolder;
import com.example.adhit.bikubiku.ui.ruangBelajarChatting.LockedMessageViewHolder;
...
public class CustomChatAdapter extends QiscusChatAdapter {
    ...
    private static final int TYPE_CLOSE_MESSAGE = 2334;
    ...
    protected int getItemViewTypeCustomMessage(QiscusComment qiscusComment, int position) {
        try {
            ...
            if (payload.optString("type").equals("end_chat")){
                return TYPE_CLOSE_MESSAGE;
            }
    ...
    protected int getItemResourceLayout(int viewType) {
        switch (viewType) {
            ...
            case TYPE_CLOSE_MESSAGE:
                return R.layout.item_message_closed;
            default:
    ...
    public QiscusBaseMessageViewHolder<QiscusComment> onCreateViewHolder(ViewGroup parent, int viewType) {
        switch (viewType) {
            ...
            case TYPE_CLOSE_MESSAGE:
                return new ClosedMessageViewHolder(getView(parent, viewType), itemClickListener, longItemClickListener);
            default:
