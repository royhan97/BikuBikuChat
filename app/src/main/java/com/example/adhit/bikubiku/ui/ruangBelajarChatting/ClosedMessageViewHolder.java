 ...
 */
public class ClosedMessageViewHolder extends QiscusBaseMessageViewHolder<QiscusComment> {
    private TextView textView;

    public ClosedMessageViewHolder(View itemView, OnItemClickListener itemClickListener, OnLongItemClickListener longItemClickListener) {
