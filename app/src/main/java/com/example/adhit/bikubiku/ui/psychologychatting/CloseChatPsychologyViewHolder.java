...
public class CloseChatPsychologyViewHolder extends QiscusBaseMessageViewHolder<QiscusComment> {
    private TextView tvUser, tvUserResult;

    public CloseChatPsychologyViewHolder(View itemView, OnItemClickListener itemClickListener, OnLongItemClickListener longItemClickListener) {
    ...
    protected View getMessageBubbleView(View itemView) {
        return itemView.findViewById(R.id.cv_close_chat_psychology);
    }
