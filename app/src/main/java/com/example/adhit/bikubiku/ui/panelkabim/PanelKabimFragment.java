package com.example.adhit.bikubiku.ui.panelkabim;
 ...
 */
public class PanelKabimFragment extends Fragment implements PanelKabimView {

    private ViewPager pager;
    private TabLayout tabs;
    private TabFragmentPagerAdapter adapter;
    private PanelKabimPresenter panelKabimPresenter;
    public PanelKabimFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view= inflater.inflate(R.layout.fragment_panel_kabim, container, false);
    ...
    public void initView(){
        ...
        panelKabimPresenter = new PanelKabimPresenter(this);
        panelKabimPresenter.showFragmentList();
    }
